...
#define BOOST_TEST_MODULE Stelo Test Suite

#include "test_stelo.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_stelo_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

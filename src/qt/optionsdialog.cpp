    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("STL-light"), QVariant("light"));
    ui->theme->addItem(QString("STL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("STL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("STL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("STL-traditional"), QVariant("trad"));

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Stelo Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Stelo Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  stelo-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Stelo in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 STL, 0.1 STL, 1 STL and 10 STL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://stelocoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://stelocoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Stelo Core is shutting down...") + "<br /><br />" +

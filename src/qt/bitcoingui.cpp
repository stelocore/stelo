    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Stelo Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Stelo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stelo: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Stelo Core"), this);
    aboutAction->setStatusTip(tr("Show information about Stelo Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Stelo Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Stelo addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Stelo addresses"));
    ...
    openAction->setStatusTip(tr("Open a stelo: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Stelo Core help message to get a list with possible Stelo Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Stelo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Stelo network", "", count));
    } else {
...
{
    QString strTitle = tr("Stelo Core"); // default title

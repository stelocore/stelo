...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000000000b3c87a0"); // 130

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000004a1054a8193686dd73c7272b142b49e8f812638fcb8545408cfaa3ba1b1"); // 130
        ...
        checkpointData = (CCheckpointData) {
            ...
            133,   // * total number of transactions between genesis and last checkpoint
                        //   (the tx=... number in the SetBestChain debug.log lines)
            650        // * estimated number of transactions per day after checkpoint
        };
    }
};

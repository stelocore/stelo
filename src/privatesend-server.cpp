...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Stelo related functionality
...
/*
    ...
    allow endless transaction that would bloat Stelo and make it unusable. To

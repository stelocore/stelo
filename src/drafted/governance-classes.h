 ...
 *
 *   // network
 *   CSteloNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.stelo.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSteloNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SteloNetwork
// //   -- signature requirements : Key1(User)
// class CSteloNetworkVariable : public CGovernanceObject
// {
// private:

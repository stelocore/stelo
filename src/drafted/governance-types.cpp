...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SteloNetwork") type = SteloNetwork;
    if(strType == "SteloNetworkVariable") type = SteloNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SteloNetwork) s = "SteloNetwork";
    if(type == SteloNetworkVariable) s = "SteloNetworkVariable";

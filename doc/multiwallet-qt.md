...
Only requiring some minor changes is stelo.cpp.
...
Changes to stelo.cpp
----------------------
stelo.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

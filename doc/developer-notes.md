...
Stelo Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 12477.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 12478 for connections and services them.
...
However, in open source software such as Stelo Core, where everyone uses
...
pay attention to for reviewers of Stelo Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Stelo Core uses tinyformat, which is type safe. Leave them out to avoid confusion

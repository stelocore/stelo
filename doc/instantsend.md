...
This mechanism has been integrated into Bitcore-Node-Stelo which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stelocoin/insight-api-stelo#web-socket-api](https://github.com/stelocoin/insight-api-stelo#web-socket-api)
* API: [https://github.com/stelocoin/insight-api-stelo#instantsend-transactions](https://github.com/stelocoin/insight-api-stelo#instantsend-transactions)
...
By default, the Stelo Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Stelo Core daemon:
